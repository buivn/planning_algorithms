...
register(
    id='Dynamic_Obstacles-v1',
    entry_point='gym_gazebo.envs.dzung1720:Dynamic_Obstacles_Env_v1',
    # More arguments here
    # Full state: laser data, distance to goal, agent's velocities, multi-targets
)

register(
    id='Dynamic_Obstacles-v0',
    entry_point='gym_gazebo.envs.dzung1720:Dynamic_Obstacles_Env_v0',
    # More arguments here
)

register(
    id='Static_Obstacles-v0',
    entry_point='gym_gazebo.envs.dzung1720:Static_Obstacles_Env',
    # More arguments here
)

register(
    id='Static_Obstacles-v1',
    entry_point='gym_gazebo.envs.dzung1720:Static_Obstacles_Env_v1',
    # More arguments here
)
...
register(
    id='b_GazeboMazeTurtlebotLidarNn-v0',
    entry_point='gym_gazebo.envs.dzung1720:GazeboMazeTurtlebotLidarNnEnv',
    # More arguments here
)
